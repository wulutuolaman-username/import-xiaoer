...
def 混合贴图(self:bpy.types.Operator, 材质, 图像节点, 贴图节点, 材质节点组, 材质输出节点):
    ...
    映射范围 = 材质.node_tree.nodes.new(type='ShaderNodeMapRange')  # type:XiaoerNode
    映射范围.location = (-550, 1440)
    小二预设模板属性(映射范围.小二预设模板, None, None, None, None)
    混合颜色 = 材质.node_tree.nodes.new(type='ShaderNodeMix')  # type:XiaoerNode
    ...
    框 = 材质.node_tree.nodes.new(type='NodeFrame')  # type:XiaoerNode
